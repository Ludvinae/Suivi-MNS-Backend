...
VALUES ( '0684545611', 'barbara.dupont99@gmail.com', 'Barbara', 'Dupont', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ( '0744123313', 'bdupont@hotmail.com', 'Barbara', 'Dupont', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ...
       ('0612457891', 'julien.morel@gmail.com', 'Julien', 'Morel', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ('0723881456', 'camille.leroy@gmail.com', 'Camille', 'Leroy', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ('0654219833', 'nicolas.bernard@gmail.com', 'Nicolas', 'Bernard', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ('0766124587', 'sophie.martin@gmail.com', 'Sophie', 'Martin', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ('0671392214', 'alexandre.robin@gmail.com', 'Alexandre', 'Robin', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ('0741589620', 'marie.garnier@gmail.com', 'Marie', 'Garnier', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ('0699114563', 'thomas.chevalier@gmail.com', 'Thomas', 'Chevalier', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ('0782341975', 'lea.fontaine@gmail.com', 'Léa', 'Fontaine', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ('0618735290', 'kevin.lambert@gmail.com', 'Kévin', 'Lambert', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ('0755441238', 'claire.perrin@gmail.com', 'Claire', 'Perrin', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ('0627886341', 'antoine.marchand@gmail.com', 'Antoine', 'Marchand', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ('0714297753', 'emma.rey@gmail.com', 'Emma', 'Rey', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
       ('0663912884', 'lucas.faure@gmail.com', 'Lucas', 'Faure', '$2a$10$V98VMxgV7myKHPE7eu7n3.GO8EUiqZGK/3ISjSriOFklF2Uvftx8u'),
...
INSERT INTO ticket (title, open_date, call_duration, current_priority, initial_priority, close_date, modification_date,
                    description, id_client, id_urgency, id_impact, id_version, current_status, id_current_theme,
                    id_current_manager, id_current_technician, overdue, id_knowledge)
VALUES  ('Ca marche pas', '2026-04-11 09:12:00', 468, 0, 0, null, '2026-04-11 10:13:00',
        'Ca marche pas', 1, 1, 1, (5), 'WAITING_CLIENT', 7,
        4, 5, false, null),
       ...
       ('Indisponibilité du service de sauvegarde en ligne', NOW(), 1035, 70,
        ...
        2, 5, 'OPEN', 3, null, null,
        true, null),

        ('Pas de menu', '2026-03-11 14:51:08', 952, 37,
         37, '2026-03-11 16:16:42', '2026-03-11 16:16:42',
         'Impossible d''accéder au items du menu', 1, 2,
         1, 2, 'CLOSED', 1, 4, 6,
         true, null),

       ('Pas de menu apparent', '2026-05-05 08:23:08', 1352, 85,
...
VALUES (1, 1, 5, '2026-04-11 09:12:00', '2026-04-11 09:27:00'),
       ...
       (2, 3, 4, '2026-03-11 15:08:08', '2026-03-11 15:26:33'),
...
VALUES ('2026-04-11 09:27:00', null, 1, 4, 5),
       ('2026-03-11 15:08:08', null, 3, 4, 6),
...
INSERT INTO activity (id_app_user, timestamp, description, activity_type)
VALUES (5, NOW(), 'A écrit un commentaire sur le ticket #1', 'COMMENT'),
       (6, '2024-04-06 09:08:07', 'A publié un procedure sur la connaissance #1', 'PROCEDURE'),
       (24, '2026-05-21 15:32:00', 'A ouvert le ticket #17', 'TICKET')
